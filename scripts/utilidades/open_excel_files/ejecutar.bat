...
title Abrir archivos Excel Comunes - Reportes SAP
echo ========================================
echo    OPEN COMMON EXCEL FILES - REPORTES SAP
echo ========================================
echo.
...
if %EXIT_CODE% equ 0 (
    ...
    echo ========================================
    echo Los archivos Excel se ejecutaron correctamente
    echo.
) else (
    echo.
    echo ========================================
