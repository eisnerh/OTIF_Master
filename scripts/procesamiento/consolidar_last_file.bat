...
title Carga último archivo materiales procesados
echo ========================================
echo    Resumen Materiales Procesados
echo ========================================
echo.
...
echo Ejecutando script de Extraer ODBC...
echo Fecha/Hora: %date% %time%
echo Usando Python: %PYTHON_EXE%
echo.
"%PYTHON_EXE%" consolidado_last_file.py
