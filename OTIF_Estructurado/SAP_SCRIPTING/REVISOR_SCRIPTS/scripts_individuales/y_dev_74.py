#!/usr/bin/env python3
"""
Script para ejecutar transacción Y_DEV_74 (Devoluciones 74)
Basado en y_dev_74.vba
"""
...
class YDev74Script(BaseSAPScript):
    """
    Script para transacción Y_DEV_74
    """
    
    def __init__(self, output_path="C:\\data"):
        super().__init__("Y_DEV_74", output_path)
        self.transaction_code = "y_dev_42000074"
        self.filename = "y_dev_74.xls"
        self.node_id = "F00139"
        self.row_number = 2
...
def main():
    ...
    script = YDev74Script(output_path)
    success = script.execute()
    
    if success:
        print("\n✅ Script Y_DEV_74 ejecutado exitosamente")
        sys.exit(0)
    else:
        print("\n❌ Script Y_DEV_74 falló")
        sys.exit(1)
